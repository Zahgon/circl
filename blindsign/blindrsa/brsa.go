...
func (c Client) Verify(message, signature []byte) error { _ = "STUB: not implemented"; return nil }
...
// Verify verifies the input (message, signature) pair and produces an error upon failure.
func (v Verifier) Verify(message, signature []byte) error { _ = "STUB: not implemented"; return nil }
...
func NewSigner(sk *rsa.PrivateKey) Signer { _ = "STUB: not implemented"; return *new(Signer) }
